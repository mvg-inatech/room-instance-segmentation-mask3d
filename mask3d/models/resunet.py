...
class MinkUNetBase(ResNetBase):
    ...
    INIT_DIM = 64
    OUT_PIXEL_DIST = 1
    NORM_TYPE = NormType.INSTANCE_NORM #BATCH_NORM, # Replaced batch with instance norm because Structured3D input is just ones
...
class ResUNet18INBN(ResUNet18):
    NORM_TYPE = NormType.INSTANCE_NORM, #INSTANCE_BATCH_NORM, # Replaced batch with instance norm because Structured3D input is just ones

...
def get_args_parser():
    ...
    parser.add_argument('--export_las', default=True, type=bool, help="Export .las file with predictions and gt")

    # Mask3D metrics calculation
    parser.add_argument('--valid_scenes_file_path', default=None, type=str, help="path to the structured3d dataset valid scenes file")
